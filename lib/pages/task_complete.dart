...
class TaskCompletePage extends StatefulWidget {
  const TaskCompletePage({super.key, this.title});

  final String? title;

  @override
  State<TaskCompletePage> createState() => TaskCompletePageState();
}

class TaskCompletePageState extends State<TaskCompletePage> {
  ...
  Future<void> getAllTask() async {
    ...
    await TaskService().getAllTasks(userId: userId, filter: "&status=true&isDelete=false").then((value) {
      if (value != null) {
        todos = value;
        searchList = [...todos];
        setState(() {});
